...
if __name__ == '__main__':
    ...
    # model = YOLO('yolov10x.pt') # YOLOv8n/s/m/l or YOLOv9c
    ...
    results = model.train(data='datasets/CADDY_gestures_complete_YOLO/CADDY_gestures_complete.yaml', epochs=32, batch=4, patience=0)
'''
